...
gene_file = open("/Users/rieke/Desktop/aeolis/files/aeolis_genes_for_OG.txt", 'r')
OG_file_path = "/Users/rieke/Desktop/ortho/OrthoFinder/Results_Feb25_6/Orthogroup_Sequences/"
path_aa_seq = "/Users/rieke/Desktop/aeolis/files/Aeolis.augustus.aa"
...
for group in gene_file:
    get_genes(group)
    new_file = open("/Users/rieke/Desktop/aeolis/groups/aeolis_group_" + group.split()[0] + ".fasta", 'w')
    for gene in genes:
