...
filenames = [img for img in glob.glob("/Users/rieke/Desktop/test/1.jpg")]
...
for bb, imgs in enumerate(filenames):
    ...
    # find contours
    (_, contours, _) = cv2.findContours(final, cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
    ...
    cv2.imwrite('/Users/rieke/Desktop/sample{}.jpg'.format(bb + 1), drawing)
    cv2.imwrite('/Users/rieke/Desktop/sample{}.jpg'.format(bb + 1), drawing2)
